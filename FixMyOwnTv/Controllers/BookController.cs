...
namespace FixMyOwnTv.Controllers
{
    public class BookController : Controller
    {
        ...
        private PageInfo GetPageObject(string article, string title)
        {
            ...
            ViewBag.floodingMenuPick = "Water/Flooding Damage";
            ...
            switch (article)
            {
                ...
                case "aboutus":
                    ...
                    break;
                case "antennas":
                    page.Title = "Get the Best Indoor TV Antenna Reception";
                    ...
                    break;
                case "backlight":
                    page.Title = "Picture Brightness Is Uneven";
                ...
                case "colors":
                    ...
                    break;
                case "could":
                    page.Title = "Fixing Your Own TV - What to Consider";
                    ...
                    break;
                case "cycling":
                    page.Title = "TV Keeps Clicking - Won't Power-Up";
                ...
                case "dlp":
                    ...
                    break;
                case "engines":
                    page.Title = "Replacing Light Engines";
                ...
                case "plasma":
                    ...
                    break;
                case "rattles":
                    page.Title = "Speaker Rattle or Buzz";
                ...
                case "solder":
                    ...
                    break;
                case "stripesandbars":
                    page.Title = "Pin Stripes, Lines or Bars";
                ...
                case "worth-fixing":
                    ...
                    page.Keywords = "fixing a TV,lightning damage,flood damage,water damage,hit by lightning,power surge,TV useful life";
